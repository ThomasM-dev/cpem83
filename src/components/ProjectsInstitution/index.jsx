  ...
  return (
    <section id="portfolio" className="portfolio section">
      <div className="container section-title" data-aos="fade-up">
        ...
        <p>
          Explora el talento y la dedicación de nuestros estudiantes a través de
          sus trabajos.
        </p>
      </div>
          ...
          >
            ...
            <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
              <div className="portfolio-card">
                <div className="image-container">
                  <img
                    src="assets/img/portfolio/portfolio-portrait-8.webp"
                    className="img-fluid"
                  ...
                  <div className="overlay">
                    <div className="overlay-content">
                      <a
                        href="assets/img/portfolio/portfolio-portrait-8.webp"
                        className="glightbox zoom-link"
