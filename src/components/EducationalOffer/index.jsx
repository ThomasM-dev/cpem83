        ...
        <div className="row align-items-center">
          <div className="col-lg-6">
            <div className="content">
              ...
              <p className="lead">
                En nuestra Institución, ofrecemos entornos de apoyo e
                inspiración para que jóvenes aprendan y crezcan con nosotros.
                También contamos con un Turno Vespertino para que adultos y
                adultas de la localidad y zonas aledañas puedan realizar su
                trayecto de educación secundaria. Nos esforzamos por formar
                pensadores seguros y creativos, y buscamos brindar una educación
                verdaderamente relevante para su futuro.
              </p>
              <p>
                Cada logro comienza con una decisión. Este puede ser el inicio de un viaje que te acompañará toda la vida.
              </p>
              <div className="stats-wrapper order-2 order-lg-1">
                ...
                <div className="stat-item">
                  <span
                    ...
                    data-purecounter-duration="1"
                  ></span>
                  <span className="label">docentes y colabores</span>
                </div>
              </div>
            </div>
          </div>
